...
-- ADICIONANDO COLUNA - 10-04-2024
ALTER TABLE DIM_USUARIO 
ADD COLUMN IS_ENABLE BOOLEAN NOT NULL DEFAULT TRUE;

ALTER TABLE DIM_USUARIO 
ADD COLUMN ID_GESTOR BIGINT,
ADD CONSTRAINT FK_ID_GESTOR_USUARIO FOREIGN KEY (ID_GESTOR) REFERENCES DIM_USUARIO (ID);

-- ADICIONADO COLUNA - 15/04/2025
ALTER TABLE DIM_USUARIO
ADD COLUMN REQUIRE_RESET BOOLEAN NOT NULL DEFAULT TRUE;
