...
| ----| --------| ------------|
RF01 | Quantidade de cards por etiqueta	| Exibir a quantidade de cards categorizados por etiquetas. |
RF02 | Quantidade de cards criados por período |	Apresentar a quantidade de cards criados em determinados períodos (diário, semanal, mensal). |
RF03 | Quantidade de cards finalizados por período |	Exibir a quantidade de cards finalizados dentro de determinados períodos. |
RF04 | Quantidade de cards por status (coluna do kanban) |	Exibir a distribuição de cards conforme o status dentro do fluxo do kanban. |
RF05 | Tempo médio de execução do card |	Apresentar o tempo médio que um card leva para ser concluído.
RF06 | Cards por colaborador |	Exibir a quantidade de cards atribuídos por colaborador. |
RF07 | Retrabalhos |	Monitorar e exibir a quantidade de retrabalhos no sistema. |
RF08 | Controle de acesso por níveis |	Definir diferentes níveis de acesso para que os indicadores sejam visíveis conforme o time do usuário. |
...
- <a href="https://www.figma.com/design/BvY58DMpMFxHHxTV2lwLh0/Stratify-WF?node-id=0-1&t=6DLJv8Jw2PygwCs3-1">WireFrames</a>
